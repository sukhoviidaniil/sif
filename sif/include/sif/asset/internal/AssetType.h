...
namespace sif::asset {
    enum struct AssetType { Undefined, Font, SpriteSingle, SpriteAtlas, SpriteGrid, PrimitiveAnimation, Sound };

    inline AssetType from_string(const std::string& s) {
        if (s == "Font")
            return AssetType::Font;
        if (s == "SpriteSingle")
            return AssetType::SpriteSingle;
        if (s == "SpriteAtlas")
            return AssetType::SpriteAtlas;
        if (s == "SpriteGrid")
            return AssetType::SpriteGrid;
        if (s == "PrimitiveAnimation")
            return AssetType::PrimitiveAnimation;
        if (s == "Sound")
